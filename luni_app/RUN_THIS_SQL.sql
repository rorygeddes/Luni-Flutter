-- ✅ SAFE SQL - Skip policies that already exist

-- Make institution_id nullable (fixes your 135 transaction errors!)
...
-- Enable Row Level Security (won't error if already enabled)
...
-- Insert default categories (no duplicates with ON CONFLICT)
